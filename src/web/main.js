...
function addSwim(swim) {
    ...
    img.src = "https://maps.googleapis.com/maps/api/staticmap?size=100x100&maptype=hybrid&path=color:0xff0000|weight:5" + coords + "&key=AIzaSyBHiKgKb3403Bnil_gtpY1BnmcKSt1c-yU";
    ...
    fetch('https://maps.googleapis.com/maps/api/geocode/json?latlng=50.179211,-4.973466&result_type=locality|political&key=AIzaSyBHiKgKb3403Bnil_gtpY1BnmcKSt1c-yU')
        .then((response) => {
